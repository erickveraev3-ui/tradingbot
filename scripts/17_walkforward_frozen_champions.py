...
OUT_DIR = root_dir / "artifacts" / "reports" / "walkforward_frozen_champions"
walkforward_v6.OUT_DIR = OUT_DIR
walkforward_v6.OUT_DIR.mkdir(parents=True, exist_ok=True)

# ---------------------------------------------------------------------
# Modos oficiales congelados
# ---------------------------------------------------------------------
CONFIG["modes"] = [
    "short_only_baseline",
...
# ---------------------------------------------------------------------
# LONG oficial congelado: elite solo en trend_up
# ---------------------------------------------------------------------
...
# ---------------------------------------------------------------------
# Resúmenes adicionales: actividad, mensual, régimen
# ---------------------------------------------------------------------
...
print("\n" + "=" * 120)
print("FROZEN CHAMPIONS SUMMARY")
print("=" * 120)
...
print("=" * 120)
print(
    "El problema de varios días sin trades NO se resuelve con más tuning del embudo.\n"
    "Se resuelve con infraestructura live correcta: heartbeat por vela cerrada, reason codes,\n"
    "paridad research/live y lectura directa desde exchange.\n"
)
