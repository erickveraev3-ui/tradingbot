...
def build_candidate_signals(df: pd.DataFrame) -> pd.DataFrame:
    """
    Candidatos con lógica más parecida a un trader profesional:
    - patrón
...
def main():
    logger.info("=" * 80)
    logger.info("CREANDO DATASET TRIPLE-BARRIER CON PATTERN ENGINE")
    logger.info("=" * 80)
    ...
    out_path = PROCESSED_DIR / "dataset_btc_triple_barrier_1h.csv"
